...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "settings.trainingPhase": { en: "Training Phase", es: "Fase de entrenamiento" },
  "settings.resetPhase": { en: "Reset training phase", es: "Reiniciar fase de entrenamiento" },
  "settings.resetPhaseConfirm": {
    en: "This will reset your 16-week training cycle. Your session history and check-ins will be kept.",
    es: "Esto reiniciará tu ciclo de entrenamiento de 16 semanas. Tu historial de sesiones y registros se mantendrán.",
  },
  "settings.resetPhaseBtn": { en: "Reset", es: "Reiniciar" },
  "settings.phaseReset": { en: "Phase reset", es: "Fase reiniciada" },
  "settings.resetPhaseHint": { en: "Resets cycle progress. Session history is preserved.", es: "Reinicia el progreso del ciclo. El historial de sesiones se conserva." },
  "settings.noActivePhase": { en: "No active training phase. Start one from the home screen.", es: "Sin fase de entrenamiento activa. Inicia una desde la pantalla principal." },
  ...
  "session.prev": { en: "← Previous", es: "← Anterior" },
  "session.skip": { en: "Skip Exercise →", es: "Saltar Ejercicio →" },
